...
#ifdef OPUSFILE_DLL
#define OPUSFILE_EXPORT __declspec(dllexport)
#else
#define OPUSFILE_EXPORT __declspec(dllimport)
#endif
...
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int opus_head_parse(OpusHead *_head,
...
/**Converts a granule position to a sample offset for a given Ogg Opus stream.
   ...
   \return The sample offset associated with the given granule position
            ...
            amount).*/
OPUSFILE_EXPORT ogg_int64_t opus_granule_sample(const OpusHead *_head,ogg_int64_t _gp)
 OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int opus_tags_parse(OpusTags *_tags,
 const unsigned char *_data,size_t _len) OP_ARG_NONNULL(2);
...
OPUSFILE_EXPORT int opus_tags_copy(OpusTags *_dst,const OpusTags *_src) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT void opus_tags_init(OpusTags *_tags) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT int opus_tags_add(OpusTags *_tags,const char *_tag,const char *_value)
...
/**Add a comment to an initialized #OpusTags structure.
   ...
   \return 0 on success, or a negative value on failure.
   \retval #OP_EFAULT An internal memory allocation failed.*/
OPUSFILE_EXPORT int opus_tags_add_comment(OpusTags *_tags,const char *_comment)
...
/**Replace the binary suffix data at the end of the packet (if any).
   ...
   \retval #OP_EFAULT An internal memory allocation failed.*/
OPUSFILE_EXPORT int opus_tags_set_binary_suffix(OpusTags *_tags,
...
OPUSFILE_EXPORT const char *opus_tags_query(const OpusTags *_tags,const char *_tag,int _count)
 OP_ARG_NONNULL(1) OP_ARG_NONNULL(2);
...
OPUSFILE_EXPORT int opus_tags_query_count(const OpusTags *_tags,const char *_tag)
 OP_ARG_NONNULL(1) OP_ARG_NONNULL(2);
...
/**Retrieve the binary suffix data at the end of the packet (if any).
   ...
   \return A pointer to the binary suffix data, or <code>NULL</code> if none
            was present.*/
OPUSFILE_EXPORT const unsigned char *opus_tags_get_binary_suffix(const OpusTags *_tags,
...
OPUSFILE_EXPORT int opus_tags_get_album_gain(const OpusTags *_tags,int *_gain_q8)
 OP_ARG_NONNULL(1) OP_ARG_NONNULL(2);
...
OPUSFILE_EXPORT int opus_tags_get_track_gain(const OpusTags *_tags,int *_gain_q8)
 OP_ARG_NONNULL(1) OP_ARG_NONNULL(2);
...
OPUSFILE_EXPORT void opus_tags_clear(OpusTags *_tags) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT int opus_tagcompare(const char *_tag_name,const char *_comment);
...
OPUSFILE_EXPORT int opus_tagncompare(const char *_tag_name,int _tag_len,const char *_comment);
...
/**Parse a single METADATA_BLOCK_PICTURE tag.
   ...
   \retval #OP_EFAULT     There was not enough memory to store the picture tag
                           contents.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int opus_picture_tag_parse(OpusPictureTag *_pic,
...
OPUSFILE_EXPORT void opus_picture_tag_init(OpusPictureTag *_pic) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT void opus_picture_tag_clear(OpusPictureTag *_pic) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT void opus_server_info_init(OpusServerInfo *_info) OP_ARG_NONNULL(1);
...
/**Clears the #OpusServerInfo structure.
   ...
   \note If you use this function, you must link against <tt>libopusurl</tt>.*/
OPUSFILE_EXPORT void opus_server_info_clear(OpusServerInfo *_info) OP_ARG_NONNULL(1);
...
/**Opens a stream with <code>fopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_fopen(OpusFileCallbacks *_cb,
...
/**Opens a stream with <code>fdopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_fdopen(OpusFileCallbacks *_cb,
...
/**Opens a stream with <code>freopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_freopen(OpusFileCallbacks *_cb,
...
/**Creates a stream that reads from the given block of memory.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_mem_stream_create(OpusFileCallbacks *_cb,
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_url_stream_vcreate(OpusFileCallbacks *_cb,
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT void *op_url_stream_create(OpusFileCallbacks *_cb,
...
/**Test to see if this is an Opus stream.
   ...
   \retval #OP_EBADHEADER The ID header was not properly formatted or contained
                           illegal values.*/
OPUSFILE_EXPORT int op_test(OpusHead *_head,
...
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_open_file(const char *_path,int *_error)
 OP_ARG_NONNULL(1);
...
/**Open a stream from a memory buffer.
   ...
   \return A freshly opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_open_memory(const unsigned char *_data,
...
/**Open a stream from a URL.
   ...
   \param[in,out] _ap    A list of the \ref url_options "optional flags" to
                         ...
                         This is a variable-length list of options terminated
                          with <code>NULL</code>.
   \return A freshly opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_vopen_url(const char *_url,
...
/**Open a stream from a URL.
   ...
   \param      ...    The \ref url_options "optional flags" to use.
                      This is a variable-length list of options terminated with
                       <code>NULL</code>.
   \return A freshly opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_open_url(const char *_url,
...
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_open_callbacks(void *_stream,
...
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_test_file(const char *_path,int *_error)
 OP_ARG_NONNULL(1);
...
/**Partially open a stream from a memory buffer.
   ...
   \param[out] _error Returns 0 on success, or a failure code on error.
                      ...
                      See op_open_callbacks() for a full list of failure codes.
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_test_memory(const unsigned char *_data,
 size_t _size,int *_error);
...
/**Partially open a stream from a URL.
   ...
   \param[in,out] _ap     A list of the \ref url_options "optional flags" to
                          ...
                          This is a variable-length list of options terminated
                           with <code>NULL</code>.
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_vtest_url(const char *_url,
 int *_error,va_list _ap) OP_ARG_NONNULL(1);
...
/**Partially open a stream from a URL.
   ...
   \param      ...     The \ref url_options "optional flags" to use.
                       This is a variable-length list of options terminated
                        with <code>NULL</code>.
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_test_url(const char *_url,
 int *_error,...) OP_ARG_NONNULL(1);
...
/**Partially open a stream using the given set of callbacks to access it.
   ...
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.
           ...
           The calling application is responsible for closing the stream if
            this call returns an error.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT OggOpusFile *op_test_callbacks(void *_stream,
 const OpusFileCallbacks *_cb,const unsigned char *_initial_data,
 size_t _initial_bytes,int *_error) OP_ARG_NONNULL(2);
...
/**Finish opening a stream partially opened with op_test_callbacks() or one of
   ...
   \retval #OP_EBADTIMESTAMP The first or last timestamp in a link failed basic
                              validity checks.*/
OPUSFILE_EXPORT int op_test_open(OggOpusFile *_of) OP_ARG_NONNULL(1);

/**Release all memory used by an \c OggOpusFile.
   \param _of The \c OggOpusFile to free.*/
OPUSFILE_EXPORT void op_free(OggOpusFile *_of);
...
OPUSFILE_EXPORT int op_seekable(const OggOpusFile *_of) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT int op_link_count(const OggOpusFile *_of) OP_ARG_NONNULL(1);
...
/**Get the serial number of the given link in a (possibly-chained) Ogg Opus
   ...
   \return The serial number of the given link.
           ...
           If the stream is not seekable, this always returns the serial number
            of the current link.*/
OPUSFILE_EXPORT opus_uint32 op_serialno(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
/**Get the channel count of the given link in a (possibly-chained) Ogg Opus
   ...
   \return The channel count of the given link.
           ...
           If the stream is not seekable, this always returns the channel count
            of the current link.*/
OPUSFILE_EXPORT int op_channel_count(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT opus_int64 op_raw_total(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
/**Get the total PCM length (number of samples at 48 kHz) of the stream, or of
   ...
   \retval #OP_EINVAL The stream is not seekable (so we can't know the length),
                       \a _li wasn't less than the total number of links in
                       the stream, or the stream was only partially open.*/
OPUSFILE_EXPORT ogg_int64_t op_pcm_total(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT const OpusHead *op_head(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
/**Get the comment header information for the given link in a (possibly
   ...
   \return The contents of the comment header for the given link, or
            ...
            an invalid link.*/
OPUSFILE_EXPORT const OpusTags *op_tags(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT int op_current_link(const OggOpusFile *_of) OP_ARG_NONNULL(1);
...
/**Computes the bitrate of the stream, or of an individual link in a
   ...
   \retval #OP_EINVAL The stream was only partially open, the stream was not
                       ...
                       links.*/
OPUSFILE_EXPORT opus_int32 op_bitrate(const OggOpusFile *_of,int _li) OP_ARG_NONNULL(1);
...
/**Compute the instantaneous bitrate, measured as the ratio of bits to playable
   ...
   \retval #OP_FALSE  No data has been decoded since any of the events
                       described above.
   \retval #OP_EINVAL The stream was only partially open.*/
OPUSFILE_EXPORT opus_int32 op_bitrate_instant(OggOpusFile *_of) OP_ARG_NONNULL(1);
...
/**Obtain the current value of the position indicator for \a _of.
   ...
   \retval #OP_EINVAL The stream was only partially open.*/
OPUSFILE_EXPORT opus_int64 op_raw_tell(const OggOpusFile *_of) OP_ARG_NONNULL(1);
...
/**Obtain the PCM offset of the next sample to be read.
   ...
   \retval #OP_EINVAL The stream was only partially open.*/
OPUSFILE_EXPORT ogg_int64_t op_pcm_tell(const OggOpusFile *_of) OP_ARG_NONNULL(1);
...
/**Seek to a byte offset relative to the <b>compressed</b> data.
   ...
   \retval #OP_EBADLINK Failed to initialize a decoder for a stream for an
                         unknown reason.*/
OPUSFILE_EXPORT int op_raw_seek(OggOpusFile *_of,opus_int64 _byte_offset) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT int op_pcm_seek(OggOpusFile *_of,ogg_int64_t _pcm_offset) OP_ARG_NONNULL(1);
...
OPUSFILE_EXPORT void op_set_decode_callback(OggOpusFile *_of,
...
OPUSFILE_EXPORT int op_set_gain_offset(OggOpusFile *_of,
...
OPUSFILE_EXPORT void op_set_dither_enabled(OggOpusFile *_of,int _enabled) OP_ARG_NONNULL(1);
...
/**Reads more samples from the stream.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              ...
                              checks.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int op_read(OggOpusFile *_of,
...
/**Reads more samples from the stream.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int op_read_float(OggOpusFile *_of,
...
/**Reads more samples from the stream and downmixes to stereo, if necessary.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int op_read_stereo(OggOpusFile *_of,
...
/**Reads more samples from the stream and downmixes to stereo, if necessary.
   ...
   \retval #OP_EBADTIMESTAMP An unseekable stream encountered a new link with
                              a starting timestamp that failed basic validity
                              checks.*/
OPUSFILE_EXPORT OP_WARN_UNUSED_RESULT int op_read_float_stereo(OggOpusFile *_of,
